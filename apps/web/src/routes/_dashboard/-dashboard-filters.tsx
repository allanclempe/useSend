...
export function DashboardFilters({
  ...
  // `no-unused-vars` here is the base ESLint rule, not the TypeScript one: it
  // reads the parameter name in a function *type* as a declaration. The config
  // fix belongs in #87, not in every file that declares a callback.
